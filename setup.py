...
if sys.platform in ('darwin','linux','linux2'):
    ...
    wd = os.path.join('pseyepy-master', 'pseyepy', 'ext')
    subprocess.call('tar -jxf libusb-1.0.21.tar.bz2', cwd=wd, shell=True)

    wd = os.path.join('pseyepy-master', 'pseyepy', 'ext', 'libusb-1.0.21')
    ...
    dest_include = os.path.join('pseyepy-master', 'pseyepy', 'ext', 'include', 'libusb-1.0')
    ...
    for ln in ['libusb-1.0.0.dylib', 'libusb-1.0.a', 'libusb-1.0.dylib', 'libusb-1.0.la']:
        ...
        dest_lib = os.path.join('pseyepy-master', 'pseyepy', 'ext', 'lib', ln)
